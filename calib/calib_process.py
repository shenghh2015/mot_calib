...
def main():
    ...
    if seq_name == 'MOT17-05-FRCNN' or seq_name == 'MOT17-06-FRCNN':
        img_size = 200
    else:
        img_size = 500
    ...
    subset    = 'train' if seq_name in MOT17_TRAIN_SEQ_NAMES + MOT20_TRAIN_SEQ_NAMES else 'test'
