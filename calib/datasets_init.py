...
from calib.processing import gen_front_mask, smoothen_tracks, smoothen_tracks_v2
import numpy as np 
import cv2 as cv
import sys
import os
...
class BoxDataLoader():
    ...
    def get_ecc_warpped_boxes_v2(self, start_frame_id, frame_window, 
                                ref_frame_id = 0, use_ecc = True):
