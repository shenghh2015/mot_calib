...
from calib.calib_losses import alpha_beta_fov_loss_v2, alpha_beta_fov_loss_v4
import numpy as np
...
def analyze_fov_loss(alpha, beta, fov_range, num_pts, *args):
    ...
    for fov in sol_space:
        loss = alpha_beta_fov_loss_v2([alpha, beta, fov], cam_params, boxes)
        losses.append(loss)
    
    return losses, sol_space.tolist()

def analyze_alpha_loss(alpha_range, beta, fov, num_pts, *args):
    ...
    for sol in sol_space:
        loss = alpha_beta_fov_loss_v2([sol, beta, fov], cam_params, boxes)
        losses.append(loss)
    
    return losses, sol_space.tolist()

def analyze_beta_loss(alpha, beta_range, fov, num_pts, *args):
    ...
    for sol in sol_space:
        loss = alpha_beta_fov_loss_v2([alpha, sol, fov], cam_params, boxes)
        losses.append(loss)
...
def analyze_s_loss_v2(alpha, beta, s_range, num_pts, *args):
    ...
    for s in sol_space:
        loss = alpha_beta_fov_loss_v4([alpha, beta, s], cam_params, boxes)
        losses.append(loss)
    
    return losses, sol_space.tolist()

def analyze_alpha_loss_v2(alpha_range, beta, s, num_pts, *args):
    ...
    for sol in sol_space:
        loss = alpha_beta_fov_loss_v4([sol, beta, s], cam_params, boxes)
        losses.append(loss)
    
    return losses, sol_space.tolist()

def analyze_beta_loss_v2(alpha, beta_range, s, num_pts, *args):
    ...
    for sol in sol_space:
        loss = alpha_beta_fov_loss_v4([alpha, sol, s], cam_params, boxes)
        losses.append(loss)
