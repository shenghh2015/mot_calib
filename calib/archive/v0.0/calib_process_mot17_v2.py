...
from calib_losses import alpha_beta_loss, fov_loss
import numpy as np
import os
import cv2
from scipy import optimize

from visualize import create_white_board, create_black_board, vis_xyz_as_images, plot_2d_pts_as_imgs
...
def main():
    ...
    video_path = track_dir + f'/{seq_name}_{round(alpha, 2)}_{round(beta, 2)}_{round(fov, 2)}.mp4'
    print(video_path)
    fps        = 15
