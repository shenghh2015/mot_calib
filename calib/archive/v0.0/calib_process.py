...
from const import MOT20_TRAIN_SEQ_NAMES
...
def main():
    ...
    frame_id = 2
    subset    = 'train' if seq_name in MOT20_TRAIN_SEQ_NAMES else 'test'
    ...
    vis_3d_draw = plot_2d_pts_as_imgs(xyh, val_rng = [20, 20], labels = ['x', 'y'], 
                        fig_size = 5, title = '')
