...
class BoxDataLoader():
    ...
    def load_tracks(self):
        ...
        print(front_masks.sum(axis = -1))
        print(np.sum(track_boxes[:, :, 3] > 0, axis = -1))
    ...
    def gen_box_pairs(self):
        ...
        for i in range(num_batchs):
            ...
            # clip_ratios = [0.5, 0.6, 0.7, 0.8, 1]

            clip_ratios = np.linspace(0.5, 1.0, 12)
            # print(f'Number of ratios: {len(clip_ratios)}')
