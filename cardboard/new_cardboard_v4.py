...
class CardBoard:
    ...
    def __init__(self, camera, rotation, 
                 transition = np.array([0, 0, 0]), cam_height = 1.):
    ...
    def reject_bboxes_above_horizon(self, bboxes):
        ...
        bc_rays  = self.rotation.rotate(bc_rays)
        bc_rays  = bc_rays + self.transition.reshape((3, 1))
    ...
    def bboxes2quadrangles3d(self, bboxes):
        ...
        quadrangle_cboards = quadrangle_cboards * self.cam_height
    ...
    def map_img_pts_to_grf_pts(self, box_pts):
        ...
        ray_3d  = ray_3d + self.transition.reshape((3, 1))
    ...
    def map_grf_pts_to_img_pts(self, xy):
        ...
        pts3d   = pts3d - self.transition.reshape((1, 3))
