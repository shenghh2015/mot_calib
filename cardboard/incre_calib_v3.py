...
class IncreCalib():
    ...
    def update_calib_GD(self, boxes, track_boxes, cb_mapping, num_iters = 5):
        ...
        print(self.alpha, self.beta, self.fov)
    ...
    def update_calib_GD_v2(self, boxes, track_boxes, cb_mapping, num_iters = 5):
        ...
        # test the initial loss
        initials = [0., 0., 0., 0., 0., 0.]
        loss = ecc_alpha_beta_fov_dt_loss2(initials, boxes, xyhw, cb_mapping, cur_cam_params)
        print(f'initial loss xx: {round(loss, 4)}')
        ...
        print('begin the incremental')
        result         = optimize.minimize(ecc_alpha_beta_fov_dt_loss2, initials, args = params, 
                        method = 'BFGS', options={'gtol': 1e-3, 'disp': False, 'maxiter': num_iters})
    ...
    def update_calib_GD_v3(self, boxes, track_boxes, cb_mapping, num_iters = 5):
        ...
        # test the initial loss
        initials = [0., 0., 0., 0., 0.]
        loss = ecc_alpha_beta_fov_dt_loss3(initials, boxes, xyhw, cb_mapping, cur_cam_params)
        print(f'initial loss xx: {round(loss, 4)}')
        ...
        print('begin the incremental')
        result         = optimize.minimize(ecc_alpha_beta_fov_dt_loss3, initials, args = params, 
                        method = 'BFGS', options={'gtol': 1e-3, 'disp': False, 'maxiter': num_iters})

        d_alpha, d_beta, d_fov, dx, dy = result.x
        dz = 0
    ...
    def update_calib_GD_v4(self, boxes, track_boxes, cb_mapping, num_iters = 5):
        ...
        # test the initial loss
        initials = [0., 0., 0., 0.,]
        loss = ecc_alpha_beta_fov_dt_loss4(initials, boxes, xyhw, cb_mapping, cur_cam_params)
        print(f'initial loss xx: {round(loss, 4)}')
        ...
        print('begin the incremental')
        result         = optimize.minimize(ecc_alpha_beta_fov_dt_loss4, initials, args = params, 
                        method = 'BFGS', options={'gtol': 1e-3, 'disp': False, 'maxiter': num_iters})
...
# corner loss
def ecc_alpha_beta_fov_dt_loss2(variables, *args):
...
# corner loss
def ecc_alpha_beta_fov_dt_loss3(variables, *args):

    d_alpha, d_beta, d_fov, dx, dy = variables
...
# corner loss
def ecc_alpha_beta_fov_dt_loss4(variables, *args):

    d_alpha, d_beta, dx, dy = variables
